...
const zh = {
  ...
  chat: { heading: "今天想聽什麼樣的風景？", subheading: "說一點心情、場景或一個 vibe。", newPlaylist: "建立新歌單", empty: "先說說現在的你。我會從一段自然的回應開始，不急著替你下定義。", typing: "Agent 正在輸入", progress: { understanding: "正在理解你想要的氛圍…", researching: "正在挑選合適的歌曲…", validating_sources: "正在確認播放來源…", completing_playlist: "第一首已經準備好，正在補齊播放清單…", updating_playlist: "正在調整播放清單…" }, placeholder: "說說你現在的心情，或給我一個 vibe。", send: "送出", sendLabel: "送出選曲需求", count: "這次選曲數量", unavailableTitle: "選曲服務目前還沒連上。", installTitle: "Pedelec 讓我能真的替你研究與選曲。", unavailableText: "確認 Pedelec 已啟動，再回來重新連線。", installText: "請安裝並啟動 Pedelec 桌面端與 Chrome Extension，再回來重新檢查；你寫好的內容會留在這裡。", desktop: "取得桌面端", recheck: "重新檢查" },
  ...
  playlist: { eyebrow: "這一段的順序", empty: "還在等你的第一句話", demo: "看看示範歌單", moveUp: "將 {title} 上移", moveDown: "將 {title} 下移", remove: "移除 {title}" },
  ...
  settingsModal: { aria: "Pedelec 設定", eyebrow: "Pedelec 設定", title: "沿用你的預設，也能在這裡覆寫", text: "Provider 會決定你的選曲要求傳往哪一個已設定的服務。", useDefault: "使用 Pedelec 預設（{provider}）", choose: "請選擇 Provider", unavailable: "原本選擇的 Provider 目前不可用，請重新選擇。", none: "目前沒有偵測到可用的 Provider，請先在 Pedelec 完成安裝或設定。", save: "儲存並重新檢查", close: "關閉設定" },
...
const en: DeepStrings<typeof zh> = {
  ...
  chat: { heading: "What kind of scene would you like to hear today?", subheading: "Share a feeling, a setting, or a vibe.", newPlaylist: "New playlist", empty: "Tell me where you are right now. I’ll begin with a natural response, without rushing to define it.", typing: "Agent is typing", progress: { understanding: "Understanding the atmosphere you want…", researching: "Choosing songs that fit…", validating_sources: "Checking playback sources…", completing_playlist: "The first track is ready; completing the playlist…", updating_playlist: "Updating the playlist…" }, placeholder: "Tell me how you feel, or give me a vibe.", send: "Send", sendLabel: "Send music request", count: "Tracks for this session", unavailableTitle: "The curation service is not connected yet.", installTitle: "Pedelec lets me properly research and curate music for you.", unavailableText: "Make sure Pedelec is running, then reconnect here.", installText: "Install and start the Pedelec desktop app and Chrome Extension, then check again; anything you have written will stay here.", desktop: "Get desktop app", recheck: "Check again" },
  ...
  playlist: { eyebrow: "The order for this stretch", empty: "Still waiting for your first words", demo: "View demo playlist", moveUp: "Move {title} up", moveDown: "Move {title} down", remove: "Remove {title}" },
